class GridFloor {
    ...
    createMesh(gl, incAxis) {
        ...
        const strideLen = Float32Array.BYTES_PER_ELEMENT * mesh.vertexComponentLen; //Stride Length is the Vertex Size for the buffer in Bytes
